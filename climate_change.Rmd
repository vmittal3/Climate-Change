...
**2. Creation of the Independent State of Bangladesh** - The liberation of (the then called) East Pakistan in 1971 into the creation of the State of Bangladesh has one important trigger. In the 1970s, several cyclones affected the areas near to the Indian Ocean. The Bhola Cyclone of 1970^[5](https://en.wikipedia.org/wiki/1970_Bhola_cyclone)^ was the deadliest of them and led to the rise of regional parties angered by the dry response of the national government for relief^[6](https://en.wikipedia.org/wiki/Bangladesh_Liberation_War)^. Surely, a lot of world leaders won't really like the idea of losing their land.  
...
What you see here is the data from NASA's NOAA and can be found here^[7](ftp://aftp.cmdl.noaa.gov/products/trends/co2/co2_annmean_mlo.txt)^. It is more than evident from this line plot that our emissions have an upward trend with 1998 proving a very bad year. 
...
This correlation plot shows an upper matrix which compares the different socio-economic factors of India with each other (data from NITI Aayog^[13](https://data.gov.in/catalog/major-socio-economic-indicators-states-india?filters%5Bfield_catalog_reference%5D=315601&format=json&offset=0&limit=6&sort%5Bcreated%5D=desc)^). A full sized image with clear captions is available separately. Here, forest cover percentage is the very last column. We see strong negative correlations with literacy rate, sex ratio, mortality rate and access to clean drinking water. Once again, this is something where the Bimaru states rank very low. We see a strong positive correlation with primary school enrollment, but to offset it, there is also a positive correlation with school dropout rate!  
...
> **Key Insight 5 - Governmental actions can greatly determine the fate of the climate and the fate of its people.**  
...
16. Press Trust of India. "Climate change: India pitches for financial support by developed nations". Accessed September 2, 2019.  https://www.indiatoday.in/india/story/climate-change-india-pitches-for-financial-support-by-developed-nations-1594093-2019-09-01
